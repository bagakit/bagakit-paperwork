...
| AI-tone lexicon risk | warning lexicon hits (for example `锁死`, `抓手`, `赋能`; source: `gate/anti-patterns/ai-tone-terms.txt`) | rewrite into owner/action/signal language; keep final decision in agent gate |
